...
<body>
    <div class="navbar bg-green-400 py-2 px-4 flex justify-between items-center">
        <div class="flex flex-col">
            ...
            <span class="ml-2">example@gmail.com</span>
        </div>
    ...
    <div class="flex flex-col items-center mt-10">
        ...
        <button id="timeButton" class="mt-4 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" onclick="changeButton()">Time in</button>
    </div>
    <!-- Rest of your dashboard content -->
</body>
</html>
